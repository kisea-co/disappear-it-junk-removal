  ...
  return <>
    <section className={styles.hero}>
      <div className="container">
        ...
        <div className={styles.rules}><span>Play: $25 off any load size</span><span>Score 500+: $50 off ½ load or larger</span><span>30 seconds</span></div>
        <p style={{maxWidth:'720px',marginTop:'16px',fontSize:'.72rem',lineHeight:1.55,letterSpacing:'.04em',color:'#b9b1a6'}}>One-time offer. Redeem either $25 off any load size or $50 off a minimum half-load service. Discounts cannot be stacked, combined, transferred or used with any other offer. Limit one Trashketball discount per customer.</p>
      </div>
    </section>
    <TrashketballGame />
  </>;
